 ...
 */
final class Version20180927232735 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE Schools (id INT AUTO_INCREMENT NOT NULL, district_id INT NOT NULL, name VARCHAR(255) NOT NULL, cds_code VARCHAR(255) NOT NULL, INDEX IDX_88F90249B08FA272 (district_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE RawData (id INT AUTO_INCREMENT NOT NULL, CDS_CODE VARCHAR(255) NOT NULL, COUNTY VARCHAR(255) NOT NULL, DISTRICT VARCHAR(255) NOT NULL, SCHOOL VARCHAR(255) NOT NULL, ETHNIC VARCHAR(255) NOT NULL, GENDER VARCHAR(255) NOT NULL, KDGN INT NOT NULL, GR_1 INT NOT NULL, GR_2 INT NOT NULL, GR_3 INT NOT NULL, GR_4 INT NOT NULL, GR_5 INT NOT NULL, GR_6 INT NOT NULL, GR_7 INT NOT NULL, GR_8 INT NOT NULL, GR_9 INT NOT NULL, GR_10 INT NOT NULL, GR_11 INT NOT NULL, GR_12 INT NOT NULL, UNGR_ELM INT NOT NULL, UNGR_SEC INT NOT NULL, ENR_TOTAL INT NOT NULL, ADULT INT NOT NULL, YEAR VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE Counties (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE Districts (id INT AUTO_INCREMENT NOT NULL, county_id INT NOT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_EA129A7F85E73F45 (county_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
